...
>> ```
> ### 4) **_.contains(_) : true or false**
> ```
> String str = "Hello, world!";
> System.out.println(str.contains("world")); // Prints: true
> System.out.println(str.contains("goodbye")); // Prints: false
> ```
> 5) **Integer.parseInt(value) : String -> int**
> 6) **Integer.valueOf(value) : String -> int Instance**
> ### 7) **_.charAt(index) : index 번째 문자 반환, String -> char 또는 StringBuilder**
> ```
> String str = "hello"
> answer = str.charAt(0); // h
> ```
> 8) **_.toString() : _ -> String**
> 9) **_.toCharArray() : String -> char Array**
> ### 10) **_.toUpperCase() 또는 _.toLowerCase() : 소문자 -> 대문자, 대문자 -> 소문자**
> 11) **_.lastIndexOf(문자) : 해당 문자의 가장 마지막 위치(index) 반환**
> 12) **String.format("%d", int) : int or Integer -> String**
> ```
...
> - https://www.freecodecamp.org/korean/news/java-string-to-int-how-to-convert-a-string-to-an-integer/
> - https://jamesdreaming.tistory.com/82, https://jamesdreaming.tistory.com/87
