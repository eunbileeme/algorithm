...
2) **Character.toUpperCase(_) : 소문자 ⏩ 대문자**
3) **Character.getNumericValue(_) : char ⏩ int**
4) **Character.isDigit() : 숫자인지 판별**
...
5) **문자열.toCharArray() : String ⏩ char Array**
- https://dlee0129.tistory.com/94
6) **문자열.toUpperCase() 또는 문자열.toLowerCase() : 소문자 ⏩ 대문자, 대문자 ⏩ 소문자**
