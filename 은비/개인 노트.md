...
2) **Character.getNumericValue(_) : char ▶ int**
...
6) **변수 이름.toUpperCase() 또는 변수 이름.toLowerCase() : 소문자 ▶ 대문자 또는 대문자 ▶ 소문자**
- https://pink-rabbit.tistory.com/9

## (🔥) **배열 이름.split("") : string ▶ string array, string.split(" ") : string ▶ string array**
- https://jamesdreaming.tistory.com/84
```
hello -> ["h","e","l","l","o"], hello -> [hello]
```

## (🔥) **배열 이름.join("", 배열 이름) : string array ▶ string**
```
["h","e","l","l","o"] -> hello
```
